...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnhistory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent Objhistory = new Intent(getApplicationContext(), History.class);
                Objhistory.putExtra("listCount", count.toString());
                startActivity(Objhistory);
            }
        });
    ...
    private void allCalculations(){
        if (!Double.isNaN(firstValue)) {
            ...
            String row1 = "" + firstValue + currentSymbol + secondValue +"";
            String result = decimalFormat.format(firstValue);

            SharedPreferences obj  = getApplicationContext().getSharedPreferences("data", MODE_PRIVATE);
            SharedPreferences.Editor dataset = obj.edit();
            dataset.putString("historydata" + count, row1 + " = " + result);
            dataset.commit();
            count++;
        }
    }
